...
def sum_over_kz(qmax=10,kz_res=10,t=-1,M=2.3,D1=0.8,D2=0.5):
    """
...
# main
def main(qmax,kz_res=10,t=-1,M=2.3,D1=0.8,D2=0.5):
    """
    Main function to plot SOTI butterfly
    """
    # sum_over_kz to get phi and eps
    phi, eps = sum_over_kz(qmax=qmax,kz_res=kz_res,t=t,M=M,D1=D1,D2=D2)
    savetxt("phi_soti_simple.csv",phi,delimiter=',')
    savetxt("eps_soti_simple.csv",eps,delimiter=',')

    return 

# run it
main(qmax=100,kz_res=5,t=-1,M=2.3,D1=0.8,D2=0.5)
